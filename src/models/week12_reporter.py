...
class Week12Reporter:
    ...
    def generate_report(self):
        ...
        print(f"\n✅ 报告已保存到: {self.save_dir}")
        
    def _generate_markdown_report(self):
        """生成Markdown格式报告"""
        
        report = f"""# 第一部分：数据准备与MLP基线 - 完整总结报告
...
"""
        ...
        # 保存报告
        report_path = self.save_dir / 'Week_1-2_Summary.md'
...
"""
        ...
        readme_path = self.save_dir / 'README.md'
...
def generate_week12_report(save_dir='reports'):
    """生成Week 1-2总结报告"""
    reporter = Week12Reporter(save_dir=save_dir)
